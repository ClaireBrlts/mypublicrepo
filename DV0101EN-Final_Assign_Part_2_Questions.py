...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales 
        ...
        unemp_effect = recession_data.groupby('Unemployment_Rate', 'Vehicle_Type')['Automobile_Sales'].mean().reset_index()                            
...
#TASK 2.6: Returning the graphs for displaying Yearly data 
        ...
        return [ 
                ...
                html.Div(className='chert-item', children=[html.Div(Y_chart3),html.Div(Y_chart4)],style={'display': 'flex'}) 
